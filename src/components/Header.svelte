...
<div class="drawer z-50">
    ...
    <div class="drawer-side">
      ...
      <ul class="menu bg-base-200 text-base-content min-h-full w-80 p-4">
        ...
        <li><a href="/geekOfTheWeek" data-sveltekit-reload class="navItem hover:text-white hover:border-b border-red-500" class:selected={currentPath === "/team"}>Geek Of The Week</a></li>
