		...
		<dialog class="modal modal-open modal-bottom sm:modal-middle">
			<div class="modal-box bg-base-100">
				...
				<div class="mt-4 space-y-4">
					...
					<p><span class="font-medium">Email:</span> {selectedDetailsApplicant.member.email}</p>
					<p><span class="font-medium">Preferred Role:</span> {selectedDetailsApplicant.role}</p>
					<p><span class="font-medium">Message:</span> {selectedDetailsApplicant.message}</p>
					<p>
						<span class="font-medium">Status:</span>
						<span
							class="badge {selectedDetailsApplicant.status === 'accepted'
								? 'badge-success'
								: selectedDetailsApplicant.status === 'rejected'
									? 'badge-error'
									: 'badge-warning'}"
						>
							{selectedDetailsApplicant.status || 'Pending'}
						</span>
					</p>
					<p>
